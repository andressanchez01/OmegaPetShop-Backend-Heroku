...
var controllerEnvio=require('../controllers/controllerEnvio.js');
var controllerCliente=require('../controllers/controllerCliente.js');
var controllerOrdencompra=require('../controllers/controllerOrdenCompra.js');
var controllerTransaccion=require('../controllers/controllerTransaccion.js');
var controllerPago=require('../controllers/controllerPago.js');
var controllerCategoria=require('../controllers/controllerCategoria.js');
var controllerProducto=require('../controllers/controllerProducto.js');
var controllerAsesor=require('../controllers/controllerAsesor.js');
var controllerLogin=require('../controllers/controllerLogin.js');
const router = Router();
